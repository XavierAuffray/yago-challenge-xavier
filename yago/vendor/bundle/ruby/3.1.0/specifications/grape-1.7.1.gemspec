...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/ruby-grape/grape/issues", "changelog_uri" => "https://github.com/ruby-grape/grape/blob/v1.7.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/grape/1.7.1", "source_code_uri" => "https://github.com/ruby-grape/grape/tree/v1.7.1" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rack>.freeze, [">= 1.3.0", "< 3"])
    ...
    s.add_dependency(%q<rack>.freeze, [">= 1.3.0", "< 3"])
